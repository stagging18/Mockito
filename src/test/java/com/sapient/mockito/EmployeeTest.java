...
public class EmployeeTest {
    ...
    public void whenFlatMapEmployeeNames_thenGetNameStream() {
        ...
        List<List<List<String>>> kk = new ArrayList<>();
        kk.add(namesNested);

        List<String> namesFlatStream = kk.stream()
        ...
        namesFlatStream.stream().peek(e->{System.out.println("** - " + e);}).count();
    ...
    public void whenCollectStreamToList_thenGetList() {
        ...
        System.out.println(employees.hashCode() + ", " + empList.hashCode());
